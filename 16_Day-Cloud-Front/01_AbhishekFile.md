...
### local regions: it is the region where the user is located. It is the closest region to the user.
### central region: it is the region where the origin server is located. It is the region where the content is stored.
### edge location: it is the region where the content is cached. It is the region where the content is delivered from.
