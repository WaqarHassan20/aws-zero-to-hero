...
- [AWS EKS](#aws-eks)
  ...
  - [Understanding Kubernetes Fundamentals](#understanding-kubernetes-fundamentals)
    - [1.1 EKS vs. Self-Managed Kubernetes: Pros and Cons](#11-eks-vs-self-managed-kubernetes-pros-and-cons)
  - [Setting up your AWS Environment for EKS](#setting-up-your-aws-environment-for-eks)
  - [2.1 Creating an AWS Account and Setting up IAM Users](#21-creating-an-aws-account-and-setting-up-iam-users)
